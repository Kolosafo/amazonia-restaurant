...
function Booking() {
  ...
  const bookEvents = [
    {
      title: "Group Bookings at Amazonia Restaurant",
      ...
      imgUrl: "/amazonia/4.jpg",
      blurUrl: "/amazonia/4.jpg",
    },
    {
      title: "Private Dining Experience",
      desc: "Book an impressive private space with us this season. Whether a corporate group seeking privacy or a carefree lunch with friends and family, Amazonia Restaurant Private Dining is one of the most prized locations for a seated dinner or evening cocktail gathering. With your own highly skilled and personable waiter for the room, we can guarantee your function will be a memorable success.",
      imgUrl: "/amazonia/13.jpg",
      blurUrl: "/amazonia/13.jpg",
    },
    {
      title: "We Offer Exclusive Use",
      desc: "From high profile celebrations to business lunches, Amazonia Restaurant caters for some of the country’s most exclusive private functions. With a spacious terrace that provides the most impressive backdrop for guests and has appealed to iconic brands, corporates, celebrities, media and magazines alike.",
      imgUrl: "/amazonia/3.jpg",
      blurUrl: "/amazonia/3.jpg",
    },
  ];
