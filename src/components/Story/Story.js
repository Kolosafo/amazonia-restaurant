  ...
  return (
    <section className={styles.container} ref={(e) => (section = e)}>
      <h2 className={styles.mainHeader}>
        The ultimate Rainforest Dining Experience
      </h2>
      ...
      <div className={styles.medContainer}>
        ...
        <div className={styles.textContainer}>
          ...
          <p>
            Amazonia Restaurant has built its reputation over the past 10 years.
            It is one of the city’s most iconic dining destinations.
            Consistently delivering excellent Pan Asian food, an innovative wine
