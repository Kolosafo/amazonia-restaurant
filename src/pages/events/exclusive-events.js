    ...
    <>
      ...
      <div className={styles.container} ref={(e) => (section = e)}>
        ...
        <div className={styles.pageText}>
          ...
          <div>
            <h3>Why Choose Amazonia Restaurant?</h3>
            <p>
              Amazonia Restaurant has developed a network of trusted
            ...
            <p>
              Amazonia Restaurant is able to cater for up to 40 people sit-down
              and 70 people stand-up. There is a balcony for pre-lunch or dinner
              drinks (weather permitting) and the priceless views of the city
              that can be absorbed by each and every guest.
            </p>
            <p>
              The minimum food and beverage spend to book Amazonia Restaurant is
            ...
            <p>
              <span>•</span>
              Exclusive use of Amazonia Restaurant; food and beverages on
              consumption, linen for all tables (this is not included in the min
              spend), labour for the duration of the function, Amazonia
          ...
          <div className={styles.imgGallery} ref={(e) => (gallery = e)}>
            ...
            <div className={styles.imgThumbnail}>
              <Image
                ...
                className={styles.item}
                placeholder="blur"
                blurDataURL="/amazonia/5.jpg"
              />
            </div>
            <div className={styles.imgThumbnail}>
              <Image
                src="/amazonia/6.jpg"
                alt="Delicious Food at Amazonia Restaurant"
                layout="fill"
                objectFit="cover"
                className={styles.item}
                placeholder="blur"
                blurDataURL="/amazonia/6.jpg"
              />
            </div>
            ...
            <div className={styles.imgThumbnail}>
              <Image
                ...
                className={styles.item}
                placeholder="blur"
                blurDataURL="/blur/amazonia/9.jpg"
              />
            </div>
            <div className={styles.imgThumbnail}>
              <Image
